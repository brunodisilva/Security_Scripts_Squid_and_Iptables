...
# $Id: access-extract.pl,v 1.23 2000/02/05 06:48:01 wessels Exp $
#
# This file is under RCS control in
#    $Source: /I2/Squid1.2_Central/Scripts/RCS/access-extract.pl,v $
#
